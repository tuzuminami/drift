# 06. API・イベント・Plugin契約
    ...
    | Method | Path | 用途 |
|---|---|---|
| `POST` | `/v1/scenarios` | Scenarioの作成 |
| `POST` | `/v1/scenarios/{scenarioId}/versions/{version}/validate` | グラフ検証 |
| `POST` | `/v1/sessions` | Session開始 |
| `POST` | `/v1/sessions/{sessionId}/events` | Event投入と遷移 |
| `GET` | `/v1/sessions/{sessionId}/context-pack` | Context Pack取得 |
    ...
    {
      "eventId": "evt_...",
      "eventType": "drift.resource.changed.v1",
